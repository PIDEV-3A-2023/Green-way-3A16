...
*/
    ...
    private ?string $type = null;
     /**
* @Assert\NotBlank(message="taux doit etre non vide")

* @ORM\Column(type="string", length=1000)
* @Assert\Range(min=0, max=100, minMessage="taux doit etre au moins 0%", maxMessage="taux ne doit pas depasser 100%")
*/
    #[ORM\Column(length: 30)]
...
*/
    ...
    private ?string $duree = null;
     /**
* @Assert\NotBlank(message="condtion doit etre non vide")

* @ORM\Column(type="string", length=1000)
*/
    #[ORM\Column(length: 30)]
    private ?string $conditionUt = null;
    ...
    public function getConditionUt(): ?string
    {
        return $this->conditionUt;
    }

    public function setConditionUt(string $conditionUt): self
    {
        $this->conditionUt = $conditionUt;
